...
img_size = 50
num_channels = 3
train_path=r'C:\Users\Acer\PycharmProjects\HGRCNN\venv\HandGestureRecognition\Traindata\Traindata'
...
def train(num_iteration):
    ...
    for i in range(total_iterations,
        ...
        if i % int(data.train.num_examples/batch_size) == 0: 
            ...
            saver.save(session, r'C:\Users\Acer\PycharmProjects\HGRCNN\venv\HandGestureRecognition\handgest_1')
